...
using Application.Contracts.GBAcc.Setups.PaymentTypes.Queries;
using Application.Contracts.GBAcc.Setups.VoucherAmountPaymentTypes.Queries;
using Application.Interfaces.Services;
using Application.ViewModel.GBAcc.Business.BankReceiptVoucher.Create;
using Domain.Enums;
...
namespace WebUIAcc.Areas.Business.Controllers
{
    ...
    public class BankReceiptVoucherController : BaseController
    {
        private readonly IDropDownService _dropDownService;

        private readonly ICurrentUserService _currentUserService;
        public BankReceiptVoucherController(IDropDownService dropDownService, ICurrentUserService currentUserService)
        {
        ...
        {
            BankReceiptVoucherCreateViewModel model = new BankReceiptVoucherCreateViewModel();
            ...
            model.DDLReceiptType = await Mediator.Send(new DDLVoucherAmountPaymentTypeQuery() { Type = Enum_VoucherAmountPaymentType.BankReceipt.ToString() });
