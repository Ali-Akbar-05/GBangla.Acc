...
namespace Application.ViewModel.GBAcc.Business.BankReceiptVoucher.Create
{
  public  class BankReceiptVoucherCreateViewModel
    {
        ...
        public string InstrumentDate { get { return VoucherDate.ToString("dd-MMM-yyyy"); } }
